...
public class Environment {
    ...
    public void pinta(int id, int idHerido, Double latitud, Double longitud) throws InterruptedException {
        ...
        if (idHerido != 0) {
            String resultado3 = Connection.connect(Environment.DISASTERS + "put/" + idHerido + "/latitud/" + latitud);
        }
        String resultado2 = Connection.connect(Environment.DISASTERS + "put/" + id + "/longitud/" + longitud);
        if (idHerido != 0) {
            String resultado4 = Connection.connect(Environment.DISASTERS + "put/" + idHerido + "/longitud/" + longitud);
        }
