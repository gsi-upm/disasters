...
<fmt:bundle basename="fmt.eji8n">
	...
	<script type="application/javascript">
		initTabs('dhtmlgoodies_tabView1',Array('<fmt:message key="gestionEmergencias"/>','<fmt:message key="emergencias"/>','<fmt:message key="heridos"/>','<fmt:message key="agentes"/>'),0,'100%',490);
	</script>
</fmt:bundle>