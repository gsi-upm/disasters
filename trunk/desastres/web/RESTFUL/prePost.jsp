	...
	<head>
		...
		<script type="text/javascript">
			...
			<c:choose>
				...
				if (type=="police"||type=="firemen"||type=="ambulance"||type=="ambulancia"||
					type=="nurse"||type=="gerocultor"||type=="assistant"||type=="otherStaff"||type=="citizen"){item="resource";valid =true;}
