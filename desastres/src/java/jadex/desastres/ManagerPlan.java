 ...
 * @author juanluis
 */
public class ManagerPlan extends Plan{
	...
	public void body(){
		...
		sp2.getParameter("type").setValue("jadex/desastres/police/police.agent.xml");
		dispatchSubgoalAndWait(sp2);
		System.out.println("Policia creado");

		IGoal sp3 = createGoal("cms_create_component");
		sp3.getParameter("type").setValue("jadex/desastres/firemen/firemen.agent.xml");
		dispatchSubgoalAndWait(sp3);
		System.out.println("Bombero creado");

		IGoal sp4 = createGoal("cms_create_component");
		//sp4.getParameter("type").setValue("jadex/desastres/ambulance/ambulance.agent.xml");
		sp4.getParameter("type").setValue("jadex/desastres/sanitarios/ManagerSanitario.agent.xml");
		...
		sp5.getParameter("type").setValue("jadex/desastres/central/central.agent.xml");
