...
/**
 *  Java class for concept Incendio of caronte ontology.
 */
public abstract class IncendioData	extends Evento implements java.beans.BeanInfo 
{
	//-------- constants ----------

	//-------- attributes ----------

	/** Attribute for slot numHeridos. */
	protected  int  numheridos;
	...
	/**
	 *  Get the numHeridos of this Incendio.
	 * @return numHeridos
	 */
	public int  getNumHeridos() {
		return this.numheridos;
	}

	/**
	 *  Set the numHeridos of this Incendio.
	 * @param numheridos the value to be set
	 */
	public void  setNumHeridos(int numheridos) {
		this.numheridos = numheridos;
	}
		...
		if(pds==null) {
			try {
				pds = new java.beans.PropertyDescriptor[]{
					 new java.beans.PropertyDescriptor("numHeridos", this.getClass(), "getNumHeridos", "setNumHeridos")
				};
	...
	/**
	 *  Get a string representation of this Incendio.
