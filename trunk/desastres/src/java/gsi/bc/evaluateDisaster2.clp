...
(defrule assignAmbulance
	;(state assign)
	?dis <- (Disaster (type ?typeDisaster)(name ?nameDisaster)(ambulancesNum ?p)(id ?idDisaster)(slight ?slight)(serious ?serious)(trapped ?trapped))
...
(defrule assignFiremen
	;(state assign)
	?dis <- (Disaster (type ?typeDisaster)(name ?nameDisaster)(firemenNum ?p)(id ?idDisaster)(size ?size)(state ?state)(slight ?slight)(serious ?serious)(trapped ?trapped))
...
(defrule freePolicemen
	;(state free)
	?dis <- (Disaster (state "erased")(id ?idDisaster)(policeNum ?p))
...
(defrule freeFiremen
	;(state free)
	?dis <- (Disaster (state "erased")(id ?idDisaster)(firemenNum ?p))
...
(defrule freeAmbulance
	;(state free)
	?dis <- (Disaster (state "erased")(id ?idDisaster)(ambulancesNum ?p))
