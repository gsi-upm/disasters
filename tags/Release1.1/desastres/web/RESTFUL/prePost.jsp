...
<script>
       ...
       <c:choose>
        ...
        var valid = false;
        if (type=="fire"||type=="flood"||type=="collapse") {item = "event"; valid=true;}
        if (type=="police"||type=="firemen"||type=="ambulance"){item="resource";valid =true;}
        if(type=="slight"||type=="serious"||type=="dead"){item="people";valid = true;}
