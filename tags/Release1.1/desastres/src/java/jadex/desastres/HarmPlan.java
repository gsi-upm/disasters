...
public class HarmPlan extends Plan {
    ...
    public void body() {
        ...
        String request = "http://localhost:8080/Disasters/rest/post/type=" + dis.getType() + "&name=" + dis.getName() + "X&quantity=1&latitud=" + latitud + "&longitud=" + longitud + "&size=" + dis.getSize() + "&traffic=" + dis.getTraffic();
        sendToDB(request);
