...
CREATE TABLE USUARIOS(ID INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY,NOMBRE_USUARIO VARCHAR(60),PASSWORD VARCHAR(60),TIPO_USUARIO INTEGER,NOMBRE_REAL VARCHAR(60),CORREO VARCHAR(60),LATITUD DECIMAL(8,6),LONGITUD DECIMAL(9,6),LOCALIZACION BOOLEAN,PLANTA INTEGER,PROYECTO VARCHAR(30),FOREIGN KEY(TIPO_USUARIO) REFERENCES TIPOS_USUARIOS(ID));
...
CREATE TABLE MENSAJES(ID INTEGER AUTO_INCREMENT NOT NULL PRIMARY KEY,CREADOR INTEGER,MENSAJE VARCHAR(250),NIVEL INTEGER,FECHA TIMESTAMP DEFAULT CURRENT_TIMESTAMP,FOREIGN KEY(CREADOR) REFERENCES USUARIOS(ID));
...
INSERT INTO TIPOS_USUARIOS VALUES(2,'coordinator',NULL,5,'Coordinador');
