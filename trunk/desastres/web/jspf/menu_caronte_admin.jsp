...
$(document).ready(function(){
  $("#submit11").click(function(){
    map.setOptions({ draggableCursor : 'url(images/iconos/target.cur) 16 16, auto' });
  });
	...
	<div id="dhtmlgoodies_tabView1">
		<div class="dhtmlgoodies_aTab">
			<form id="catastrofes" action="#">
				...
				<input type="button" id="eliminar1" class="btn oculto" value="Eliminar" onclick="boton_eliminar(marcadores_definitivos[iden.value],definitivo);"/>
