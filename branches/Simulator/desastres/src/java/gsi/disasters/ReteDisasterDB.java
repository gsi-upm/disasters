	 ...
	 * @param idResource the resource id in the application
		...
		//Por cada desastre:
               for (int i=0;i<desastres.length();i++){
                    ...
                    Disaster nuevo = new Disaster(
                            instancia.getInt("id"),
                            DisasterType.getType(instancia.getString("type")),
                            instancia.getString("name"),
                            instancia.getString("info"),
                            instancia.getString("description"),
                            ...
                            StateType.getType(instancia.getString("state")),
                            SizeType.getType(instancia.getString("size")),
                            DensityType.getType(instancia.getString("traffic")),
                            0,0,0,0
                            );
		...
		for (int i=0;i<personas.length();i++){
                    ...
                    People nuevo = new People(
                            ...
                            instancia.getInt("id"),
                            InjuryDegree.getType(instancia.getString("type")),
                            instancia.getString("name"),
                            instancia.getString("info"),
                            instancia.getString("description"),
                            instancia.getInt("idAssigned"),
                    ...
                    if(nuevo.getType().equals(InjuryDegree.SLIGHT)){dis.setSlight(nuevo.getQuantity());}
                    if(nuevo.getType().equals(InjuryDegree.SEVERE)){dis.setSerious(nuevo.getQuantity());}
                    if(nuevo.getType().equals(InjuryDegree.DEAD)){dis.setDead(nuevo.getQuantity());}
                    if(nuevo.getType().equals(InjuryDegree.TRAPPED)){dis.setTrapped(nuevo.getQuantity());}
		...
		for (int i=0;i<personas.length();i++){
                    ...
                    if(nuevo.getState().equals(StateType.ERASED)){nuevo.setQuantity(0);}
