...
import jadex.commons.collection.MultiCollection; // jadex.util.collection.MultiCollection;
import jadex.commons.SimplePropertyChangeSupport; // jadex.util.SimplePropertyChangeSupport;
...
public class Environment {
     ...
     * Puesto que de momento solo tenemos Madrid en la lista,
